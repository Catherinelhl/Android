...
<NSObject, SCIChartControllerProtocol, SCIInvalidatableElementProtocol, SCIThemeableProtocol, SCISuspendableProtocol, SCIAnimationContextInvalidate>
/** @{ @} */
...
@interface SCIChartSurface : SCIChartSurfaceView <SCIChartSurfaceProtocol, SCIRenderSurfaceCallbackDelegateProtocol> {
}
